...
const newsArticles = [
  ...
  {
    id: 2,
    title: 'INIXII Finishes 6th Overall at TSAE Auto Challenge 2026',
    date: 'February 2026',
    category: 'Competition Result',
    excerpt: 'At the 20th TSAE Auto Challenge (Feb 5–7, 2026, Pathum Thani Speedway), INIXII secured 6th place Overall, the Ansys Simulation Award presented by CADFEM Thailand, 1st Runner-Up in the Efficiency Event, and 1st Runner-Up in Category EV.',
    image: '/Race2569-302.jpg',
  },
  {
    id: 3,
    title: 'Winner — Ansys Simulation Award at TSAE Auto Challenge 2026',
    date: 'February 2026',
    category: 'Award',
    excerpt: 'INITIAL Formula Student received the Ansys Simulation Award presented by CADFEM Thailand, recognizing our simulation-driven engineering — from ANSYS CFD-verified cooling to topology-optimized brake components.',
    image: '/TSAE.avif',
  },
  {
    id: 4,
    ...
    date: '2025',
    category: 'Vehicle',
    excerpt: 'Meet INIXII, our 4WD electric formula car with four in-hub motors, torque vectoring, and wind-tunnel-verified aerodynamics. Built by over 30 engineers across mechanical, electrical, and software disciplines.',
    image: '/DSC05116.jpg',
  },
  {
    id: 5,
